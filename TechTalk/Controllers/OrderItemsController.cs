...
namespace TechTalk.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderItemId,OrderId,ProductId,Quantity,UnitPrice")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderItemId,OrderId,ProductId,Quantity,UnitPrice")] OrderItem orderItem)
        {
            if (ModelState.IsValid)
            {
